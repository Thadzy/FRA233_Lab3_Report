...
% Override the 'plain' page style to ensure the page number remains on the bottom right
% This is important because commands like \maketitle or \chapter often force the 'plain' style
...
\input{sections/02_exp1.tex}
\input{sections/03_exp2.tex}
\input{sections/04_exp3.tex}
\input{sections/05_exp4.tex}
\input{sections/06_exp5.tex}
