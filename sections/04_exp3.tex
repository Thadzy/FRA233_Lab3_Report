...
\begin{table}[htbp]
    \centering
    \caption{สรุป Trade-off ของแต่ละระดับ $Q$}
    \label{tab:qr_tradeoff}
    \begin{tabular}{ccccc}
        \hline
        \textbf{ค่า $Q$} & \textbf{$Q/R$} & \textbf{$K_{k,\mathrm{ss}}$} & \textbf{Smoothness} & \textbf{Response Time} \\
        \hline
        $1\times10^{-3}$ & $2.97\times10^{-2}$ & สูง ($\approx 0.136$) & ต่ำ & เร็ว \\
        $1\times10^{-5}$ & $2.97\times10^{-4}$ & กลาง ($\approx 0.017$) & กลาง & กลาง \\
        $1\times10^{-6}$ & $2.97\times10^{-5}$ & ต่ำ ($\approx 0.005$) & สูง & ช้า \\
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.85\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/Scenario A - Average Across All Trials.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.85\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/Scenario B - Average Across All Trials.png}
...
\subsubsection{Error Plot — ส่วนต่างระหว่าง KF Output กับ Raw Data}

รูปที่~8 แสดง Residual $e_k = z_k - \hat{x}_k$ สำหรับแต่ละค่า $Q$
ใน Scenario A (ระยะคงที่) ซึ่งสะท้อนให้เห็นว่า $Q$ ที่ต่ำกว่า
ทำให้ Filter กรอง Noise ได้มากกว่า (Residual มีขนาดเล็กกว่า)
แต่แลกกับการที่ Filter ตอบสนองต่อการเปลี่ยนแปลงช้าลง
