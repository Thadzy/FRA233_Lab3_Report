...
จากการวิเคราะห์ข้อจำกัดที่พบในการทดลอง มีข้อเสนอแนะเพื่อปรับปรุงความแม่นยำและต่อยอดในอนาคตดังนี้
 
\begin{itemize}
    \item \textbf{เพิ่มจำนวน Sample ต่อ Trial:} การเก็บ 500 Sample ต่อ Trial อาจไม่เพียงพอเมื่อ HC-SR04 มี Spike เกิดขึ้นแบบไม่สม่ำเสมอ ควรเพิ่มเป็นอย่างน้อย 1000 Sample ต่อ Trial เพื่อให้ค่า $R$ ที่ประมาณได้ไม่ถูกดึงโดย Outlier ในช่วงสั้น
    \item \textbf{พิจารณา Distance-Dependent $R$:} ค่า $R$ ที่เลือกจากระยะ 20 cm เป็นเพียงค่าคงที่เฉลี่ย แต่ใน Operating Range จริงของระบบ MSD Displacement เปลี่ยนแปลงตลอดเวลา ในอนาคตอาจสร้าง Lookup Table ของ Variance ตามระยะ แล้วอัปเดต $R$ แบบ Real-time เพื่อให้ Filter ปรับตัวตาม Noise ที่แท้จริงของแต่ละระยะ
    % \item \textbf{ทดสอบด้วยพื้นผิวสะท้อนที่หลากหลาย:} การทดลองนี้ใช้วัตถุแบนเพียงชนิดเดียว ควรทดสอบกับพื้นผิวที่มีมุมและวัสดุต่างกันเพื่อประเมินว่า Variance ของ HC-SR04 ขึ้นอยู่กับคุณสมบัติของพื้นผิวสะท้อนด้วยหรือไม่
\end{itemize}