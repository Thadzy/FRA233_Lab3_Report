...
/**
 * @brief  2-State Kalman Filter state structure
 *         State: x0 = position (m from equilibrium)
 *                x1 = velocity (m/s)
 *         P matrix stored as upper triangle: p00, p01, p11
 */
typedef struct {
...
float Kalman2_Update(Kalman2State_t *kf, float measurement)
{
    ...
    /* =================================================================
     * PREDICT STEP
     * State Transition Matrix (Euler Forward):
     *   A = [ 1       dt   ]
     *       [ -w2*dt  1-z2*dt ]
     * ================================================================= */
