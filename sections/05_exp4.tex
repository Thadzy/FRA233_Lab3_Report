...
\begin{itemize}
    \item \textbf{ลดแรงเสียดทานจาก Guide Rail:} แรงเสียดทานที่เกิดจากการสัมผัสระหว่างฐานมวลกับเสาไกด์ทำให้ค่า $C$ ที่ประมาณได้สูงกว่าความเป็นจริงและไม่คงที่ระหว่าง Trial ควรพิจารณาใช้แนวทาง เช่น เพิ่ม Linear Bearing หรือ Bushing ที่มีแรงเสียดทานต่ำเพื่อให้ค่า $C_{\text{eff}}$ สะท้อน Damping จริงมากขึ้น
    \item \textbf{เพิ่มจำนวน Trial สำหรับ Parameter Estimation:} การทดลองนี้ใช้เพียง 5 Trial และต้องตัด Outlier ออก 1 Trial ทำให้เหลือเพียง 4 Trial สำหรับการเฉลี่ย ควรเพิ่มเป็นอย่างน้อย 8--10 Trial เพื่อให้ค่าเฉลี่ยของ $K$ และ $C$ มีความเสถียรทางสถิติมากขึ้น โดยเฉพาะเมื่อมี Outlier เกิดขึ้น
    \item \textbf{พิจารณาใช้ Nonlinear Model:} Linear MSD Model สมมติให้ $K$ และ $C$ คงที่ตลอดช่วง Displacement ซึ่งทำให้ค่า Fit\% เฉลี่ยอยู่ที่เพียง 55.5\% ในอนาคตอาจพิจารณาสร้างแบบจำลองที่รวม Nonlinear Damping เช่น Coulomb Friction เข้าไปด้วย เพื่อให้ Parameter Estimator หาค่า $C$ ได้แม่นยำยิ่งขึ้น
\end{itemize}
