...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/FBD.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/damp.png}
...
\begin{equation}
    J(C) = \sum_{k=1}^{N}
           \left[ x_\text{measured}(t_k) - x_\text{simulated}(t_k;\,C) \right]^2
    \label{eq:param_est_cost}
\end{equation}

Algorithm จะค้นหาค่า $C$ ที่ทำให้ $J(C)$ มีค่าต่ำที่สุด
โดย Fix ค่า $K$ และ $m$ ไว้ตลอดกระบวนการ
...
เพื่อประเมินความถูกต้องของ Model ที่ Identify ได้ใช้ตัวชี้วัด 3 ตัว ดังนี้

\paragraph{RMSE (Root Mean Square Error)}

บอกขนาดของ Error โดยเฉลี่ยในหน่วยเดียวกับข้อมูลจริง
ยิ่งเข้าใกล้ 0 ยิ่งดี:
...
\paragraph{NRMSE (Normalized RMSE)}

นำ RMSE หารด้วยพิสัยหรือค่าเฉลี่ยของข้อมูลจริง
เพื่อให้ค่าออกมาเป็นสัดส่วนที่เทียบกันได้ง่าย ไม่มีหน่วย:

\begin{equation}
    \text{NRMSE} = \frac{\text{RMSE}}{\max(y_i) - \min(y_i)}
    \label{eq:nrmse}
\end{equation}

\paragraph{Fit Percentage (Percent Fit)}

ตัวชี้วัดที่ MATLAB Parameter Estimator รายงานโดยตรง
บอกว่า Model อธิบายความแปรปรวนของข้อมูลจริงได้กี่เปอร์เซ็นต์
100\% คือ Model ทับข้อมูลจริงทุกจุด, 0\% คือ Model อธิบายอะไรไม่ได้เลย:

\begin{equation}
    \text{Fit} = 100 \times
    \left(1 - \frac{\|\mathbf{y} - \hat{\mathbf{y}}\|}
                    {\|\mathbf{y} - \bar{y}\,\mathbf{1}\|}\right)
    \label{eq:fit_percent}
\end{equation}

โดยที่ $\|\cdot\|$ คือ Euclidean Norm, $\bar{y}$ คือค่าเฉลี่ยของข้อมูลจริง
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.90\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/Simulink.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.85\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/c.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.85\textwidth]{/Users/thadzy/Documents/01_Active/University/FRA233-Control/Lab3/FRA233_Lab3_Report/images/Figure 12b.png}
